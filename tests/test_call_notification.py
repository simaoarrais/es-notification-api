import json
from src.call_notification import send_notification
from unittest import mock
from twilio.base.exceptions import TwilioRestException

@mock.patch('src.call_notification.client.calls.create')
def test_send_notification(create_message_mock):
    ...
    #Mock the API
    expected_sid = 'CAf981a3da3e92a7b611a6b1df11f8c80b'
    create_message_mock.return_value.sid = expected_sid

    #Create message request
    message = {
        "phone_number": "+351910779088",
